...
- MERA-targets-final.txt: MERA-targets.txt with hand-edits (n=1129)
...
- MERA-targets-final-salient.gaz.txt: Gazette with generic names
  removed (e.g., Contact, Edge, Fine) that were causing spurious hits (n=1107)
...
- MERA-targets.txt: union of MERA-{closeout*,CS-targets,targets-added}.txt files (n=1130)
