...
hematite.  The resulting Mars Target Encylopedia serves as a resource
that can inform 
...
- biomedical IE - Tikk et al. 2010, Thomas et al. 2011.  Bui et
al. 2011

- scientific pubs - extracting citations, summarizing documents
  (Ronzano et al., 2016), Narasimham et al. 2016?, Choi et al. 2016,
  Tsutsui et al., 2016
...
Baseline: Lists only & 0.585 & 0.831 & 0.687 \\ \hline  % LPSC16-test
