...
if __name__ == "__main__":
    ...
    if args.predict_with_extracted_gold_entities:        
        ...
        test_file = join(args.test_dir, f"extracted_gold_spanins.pkl")

    else:
        print("using system entities for evaluation")
        test_file = join(args.test_dir, f"extracted_system_spanins.pkl")

    with open(test_file, "rb") as f:
        test_ins = pickle.load(f)

  
    with open(join(args.test_dir, f"annotated_gold_spanins.pkl"), "rb") as f:
